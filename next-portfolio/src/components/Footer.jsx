      ...
      <div className="max-w-7xl mx-auto flex flex-col justify-between min-h-[60vh]">
        ...
        <div className="footer-reveal mt-24 border-t border-zinc-800 pt-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-8 text-xs font-bold tracking-widest uppercase text-zinc-400">
          ...
          <div className="flex gap-8">
            {/* 👇 Fixed LinkedIn URL */}
            <a 
              href="https://www.linkedin.com/in/vishal-kumar-3a81271a1" 
              target="_blank" 
              rel="noreferrer" 
            ...
            <a 
              href="https://github.com/Viishalkr" 
              target="_blank" 
              rel="noreferrer" 
              className="hover:text-white transition-colors"
            >
            ...
            {/* 👇 Fixed Instagram URL */}
            <a 
              href="https://www.instagram.com/viishal.kr" 
              target="_blank" 
              rel="noreferrer" 
              className="hover:text-white transition-colors"
            >
          ...
          <div className="text-zinc-600">
            DESIGNED & ENGINEERED BY VISHAL KUMAR
          </div>
